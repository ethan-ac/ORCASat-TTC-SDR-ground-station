...
class gndstation_hiers(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.zeromq_sub_msg_source_1 = zeromq.sub_msg_source('tcp://127.0.0.1:5555', 100, )
        ...
        self.msg_connect((self.zeromq_sub_msg_source_1, 'out'), (self.encode_hier_0, 'in'))
        self.connect((self.blocks_mute_xx_0, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.blocks_mute_xx_0, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_mute_xx_0, 0), (self.uhd_usrp_sink_0, 0))
